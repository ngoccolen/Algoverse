                    ...
                    <div className="flex flex-col md:flex-row gap-4 mb-10">
                        ...
                        <div className="relative w-full md:w-1/2">
                            ...
                            <input
                                ...
                                className="w-full bg-slate-900 p-3 pl-10 rounded-md border border-slate-700 focus:outline-none focus:border-purple-500 transition text-white"
                                value={searchTerm}
                        ...
                        {/* Difficulty */}
                        <select
                            className="bg-slate-900 p-3 rounded-md border border-slate-700 focus:outline-none focus:border-purple-500 text-white"
                                    ...
                                    >
                                        <div>
                                            <div className="flex justify-between items-start mb-2">
                                                <h3 className="text-xl font-bold text-white group-hover:text-purple-400 transition line-clamp-2">{problem.title}</h3>
                                                {problem.solved > 0 && (
                                                    <span className="text-[10px] bg-blue-900 text-blue-200 px-1.5 py-0.5 rounded whitespace-nowrap ml-2">Solved</span>
                                                )}
                                            </div>
                                            <div className="flex gap-2 mb-3 text-xs text-gray-500">
                                                <span className="bg-slate-800 px-2 py-1 rounded border border-slate-700">{problem.category || "General"}</span>
                                            </div>
                                            {/* Hiển thị Difficulty */}
                                            <div className="mb-4">
